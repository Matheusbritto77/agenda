    ...
    <GuestLayout>
        ...
        <div class="space-y-6">
            ...
            <form @submit.prevent="submit" class="text-left space-y-4">
                ...
                <div class="p-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-xs space-y-1">
                ...
                <button
                    type="submit"
                    class="w-full py-3 px-4 text-xs sm:text-sm font-extrabold rounded-xl bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2 cursor-pointer transition-all duration-200 mt-4"
