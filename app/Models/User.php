...
#[Fillable(['name', 'email', 'phone', 'country_code', 'avatar_url', 'password', 'parent_id', 'role_title', 'must_reset_password', 'subdomain', 'custom_domain', 'active_domain_type', 'role_permissions', 'custom_roles'])]
